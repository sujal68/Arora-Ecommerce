                        ...
                        <div style={{ minWidth: 720 }}>
                            ...
                            {isLoading ? (
                                Array.from({ length: 5 }).map((_, i) => (
                                    <div key={i} style={{ display: 'grid', gridTemplateColumns: '1.4fr 1.2fr 1.2fr 0.6fr 0.8fr 100px 80px', padding: '12px 20px', borderBottom: i < 4 ? `1px solid #F6F4F0` : 'none', alignItems: 'center', background: COLORS.white }}>
                                        <div>
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
                                            <div className="shimmer" style={{ width: 20, height: 20, borderRadius: 5 }} />
                                            <div className="shimmer" style={{ width: 60, height: 16, borderRadius: 5 }} />
                                        </div>
                                        <div className="shimmer" style={{ width: 35, height: 13 }} />
                                        <div className="shimmer" style={{ width: 30, height: 13 }} />
                                        <div>
